...
{
    using ModuleInfo = CThePlugin::ModuleInfo;
    using list_type  = std::vector<path_translator_base*>;
    using smart_ptr  = path_translator_base*;
    ...
    //
    path_translator_base() : npath(0), fun(nullptr), iat(nullptr), bIsSingleton(false)
    { }
    ...
    struct CallInfo
    {
        ...
        CallInfo() : asi(nullptr), base(nullptr), bSetDir(false)
        {}
